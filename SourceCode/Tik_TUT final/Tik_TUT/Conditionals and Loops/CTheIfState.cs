...
{
    public partial class CTheIfState : Form
    {
        public CTheIfState()
        {
            InitializeComponent();
            ...
            if (!Form1.check_16 )
            {
                ...
                txtText_8.Text = "y";
                txtText_8.ForeColor = Color.GreenYellow;
                txtText_8.Enabled = false;
                btSub_8.Visible = false;
                btSub_10.Visible = true; Form1.bScore = 16;
            }
            if (!Form1.check_17)
            {
            ...
            if (!Form1.check_18)
            {
                ...
                btSub_4.Visible = false; Form1.bScore = 18;
            }
            #endregion
        }
        ...
        {
            if (txtText_8.Text.Trim().Equals("y"))
            {
                foreach (KeyValuePair<string, User> entry in Form1.user)
                {
                    if (!Form1.user.ContainsKey(Form1.username)) { return; }
        ...
        {
            if (txtText1_10.Text.Trim().Equals("a") && txtText2_10.Text.Trim().Equals("b") && txtText3_10.Text.Trim().Equals("cout"))
            {
                foreach (KeyValuePair<string, User> entry in Form1.user)
                {
                    if (!Form1.user.ContainsKey(Form1.username)) { return; }
        ...
        {
            if (txtText1_4.Text.Trim().Equals("if") && txtText2_4.Text.Trim().Equals("y"))
            {
                foreach (KeyValuePair<string, User> entry in Form1.user)
                {
                    if (!Form1.user.ContainsKey(Form1.username)) { return; }
